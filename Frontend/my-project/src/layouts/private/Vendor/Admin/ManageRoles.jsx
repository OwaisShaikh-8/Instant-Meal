...
import { useCreateRolesMutation } from "../../../../services/roles-api.js";
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-red-600 leading-relaxed">
                      For large-scale food businesses, assigning roles like Admin,
                      Manager, Chef, and Delivery Partner helps streamline workflows
                      and improve efficiency. Each role will have access to a
                      dedicated dashboard with specific permissions.
                    </p>
                  </div>
                </div>
                <button
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm text-blue-800 leading-relaxed">
                          <span className="font-semibold">Note:</span> After assigning
                          these roles, a role-based system will be activated in your
                          business. Each role will have access to their own customized
                          dashboard with specific permissions and features relevant to
...
<div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
  <div className="flex items-center justify-between mb-6">
    <div className="flex items-center gap-3">
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-800">Active Roles</h3>
        <p className="text-sm text-gray-500">Your team configuration</p>
      </div>
    </div>
    <button
      onClick={() => setAddRolesActive(true)}
      ...
      >
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 text-lg">{role.label}</h4>
              <p className="text-xs text-gray-500">Role assigned</p>
            </div>
          </div>
        ...
        <div className="space-y-2 mt-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-800 font-semibold">
              {/* Replace with actual data: loggedInUser?.roles?.[role.name]?.personName */}
              [Name will appear here]
            </span>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span className="text-gray-600 font-medium">Access:</span>
            <span className="text-gray-800">Dashboard & Permissions</span>
          </div>
        </div>
      </div>
    ))}
  ...
  <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
    <div className="flex gap-3">
      <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
      <div>
        <p className="text-sm font-medium text-blue-900">Role-Based System Active</p>
        <p className="text-xs text-blue-700 mt-1">
          Each team member has access to their customized dashboard with role-specific features and permissions.
        </p>
      </div>
    </div>
  </div>
